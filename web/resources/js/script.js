...
let canvas = document.querySelector("#cartesianSystemCanvas");
...
// 1part
    ...
    c.fillRect(width/2,height/2-radius/2, radius, radius);
...
// 2part circle of 3 part r= r/2
    ...
    c.arc(width/2, height/2, radius, Math.PI*0.5, Math.PI);
    c.fill();
